...
import { getWorkoutById, getWorkouts, createWorkout, updateWorkout, deleteWorkout } from '../controllers/workouts.model.js';
...
router.post('/', [
    ...
    check('exercises.exercise','El exercises.exercise no es válido').isMongoId(),
